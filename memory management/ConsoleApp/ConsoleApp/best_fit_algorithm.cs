...
public class Bfa//最佳适应算法
{
    private readonly List<Partition> _list;

    private  int _sumlen;
    private readonly Comparison<Partition> _pfLenComparison = PfLenCompare;

    private static int PfLenCompare(Partition x, Partition y)
    {
